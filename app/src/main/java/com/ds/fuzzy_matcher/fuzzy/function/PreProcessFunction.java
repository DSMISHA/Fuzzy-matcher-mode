...
import com.ds.fuzzy_matcher.fuzzy.component.Dictionary;
import com.ds.fuzzy_matcher.fuzzy.util.Utils;
...
import java.util.function.Function;
    ...
    static PreProcessFunction nameNormalization() {
        return new PreProcessFunction() {
            @Override
            public Object apply(Object obj) {
                return Utils.getNormalizedString(obj.toString(), Dictionary.nameDictionary);
            }
        };
    }
